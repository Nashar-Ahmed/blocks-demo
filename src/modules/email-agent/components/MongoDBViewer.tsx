...
import { RefreshCw, ChevronLeft, ChevronRight, Mail, Calendar, Brain, Sparkles, AlertTriangle, CheckCircle2, Clock, Send } from 'lucide-react';
import { Textarea } from '@/components/ui-kit/textarea';
import { api } from '@/lib/api/email-agent-api';
import type { Email } from '@/lib/api/email-agent-api';
